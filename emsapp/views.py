from emsapp.forms import LeaveApplicationForm
...
def to_do_list(request):
     ...
     working_todo_list = TodoList.objects.filter(user = request.user , pending_status=False, working_status = True)
     working_todo_list_count = working_todo_list.count()

     done_todo_list = TodoList.objects.filter(user = request.user , pending_status=False, working_status = False , done_status = True)
     done_todo_list_count = done_todo_list.count()
     
     form = TodoListForm()

     context = {'my_todo_list_pending':my_todo_list_pending,
                'my_todo_list_pending_count':my_todo_list_pending_count,
                'working_todo_list':working_todo_list,
                'working_todo_list_count':working_todo_list_count,
